...
const LinkButton = ({ name, to, width = "auto" }) => {
   return (
      <Link
         to={to}
         className="px-5 py-2 relative bg-ourPrimary group lightLinkButton overflow-hidden font-medium text-white border-2 border-ourPrimary mr-2 hover:border-white hover:text-ourPrimary flex justify-center items-center"
         style={{ width }}
      >
