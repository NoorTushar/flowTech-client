...
const LinkButton = ({ name, to, width = "auto" }) => {
   return (
      <Link
         to={to}
         className="px-5 py-2 relative  group lightLinkButton overflow-hidden font-medium bg-transparent text-white border-2 border-ourPrimary mr-2 hover:border-ourPrimary hover:text-white flex justify-center items-center"
         style={{ width }}
      >
